    ...
    <div className="relative min-h-[100svh] bg-gradient-to-br from-primary/5 via-background to-primary/10 overflow-hidden">
      ...
      <div className="container relative mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 z-10">
        <section className="text-center mb-24 animate-fadeIn">
          ...
          <p className="text-xl sm:text-2xl text-muted-foreground max-w-3xl mx-auto mb-12 leading-relaxed animate-fadeIn">
        ...
        {filteredResources.length > ITEMS_PER_PAGE && (
          <div className="flex justify-center items-center mb-24 gap-6 animate-fadeIn">
            <Button
              variant="outline"
